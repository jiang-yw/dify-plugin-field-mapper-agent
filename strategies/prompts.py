...
def tod_extract_prompt(fields: list, user_input: str) -> str:
    ...
    for field in fields:
        ...
        if getattr(field, "mapping", None):
            spec["mapping"] = field.mapping
    ...
    5. If a field provides mapping or options, return the mapped target value when the user input matches a label, alias, name, or value
